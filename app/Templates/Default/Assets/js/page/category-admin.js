	...
	$("#newItemForm").validate({
		rules : {
			...
			code:{
				required:true,
				remote : {
					url : '/cat-prj/category/checkCode',
					type : 'GET',
					data : {
						code : function(){
